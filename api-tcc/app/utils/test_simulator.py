...
def simulate_video_from_image(image_path: str) -> str:
    ...
    logger.info("🧪 TESTE ATIVO: Convertendo imagem num vídeo de 20 frames para simulação de carga...")
    ...
    try:
        ...
        logger.warning(f"Não foi possível apagar imagem original durante simulação: {e}")
